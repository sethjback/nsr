// heavily based on https://github.com/julienschmidt/httprouter
package nsr
...
// given path.
func (n *node) getValue(path string) (handler Handler) {
...
// was successful.
func (n *node) findCaseInsensitivePath(path string) (fixedPath string, found bool) {
...
func (n *node) findCaseInsensitivePathRec(path string, ciPath []byte, rb [4]byte) []byte {
	npLen := len(n.path)
